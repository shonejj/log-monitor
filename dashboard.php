...
<html lang="en">
    <head>
        ...
        <?php $file = 'assets/config/config.php';
            ...
            if(!is_file($file)){
                copy('assets/config/config.sample-06feb24.php', $file);
            }
...
<form action="assets/php/logout.php" method="post">
    <button type="submit"  class="logout-btn">Logout</button>
                ...
                <div id="righttop" class="righttop">
                    <form method="POST">
                        <div id="markform">
                            ...
                            <input type="search" name="markinput"  id="text-search2" class="input" title="Input search term" placeholder=" Search & highlight . . ."  style="border-bottom: 2px solid #4CAF50;"required>
        ...
        <div class="footer">log glitch scope</div>
